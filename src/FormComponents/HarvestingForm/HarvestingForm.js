...
import './HarvestingForm.css';
import Sidebar from "../../Sidebar/Sidebar";

class HarvestingForm extends React.Component {
    constructor(props) {
        super(props);
        this.state = ({
            event: 'Harvest',
            ...
            <div onClick={(e) => { this.Sidebar.hidesidebar(e) }}>
                ...
                <div className="form_wrapper">
                    <div className="formHeader">
                        <div className="titleWrapper">Insert new <strong style={{ color: "#009688" }}>harvesting</strong> data</div>
                    </div>
